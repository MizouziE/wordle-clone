...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  guessesAllowed: 5,
  theWord: _words__WEBPACK_IMPORTED_MODULE_1__.answers[Math.floor(Math.random() * _words__WEBPACK_IMPORTED_MODULE_1__.answers.length)].toLowerCase(),
  currentRowIndex: 0,
  state: 'active',
  errors: false,
  message: '',
  ...
  submitGuess: function submitGuess() {
    ...
    if (!_words__WEBPACK_IMPORTED_MODULE_1__.words.includes(this.currentGuess.toUpperCase())) {
      this.errors = true;
