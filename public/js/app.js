...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  guessesAllowed: 3,
  theWord: _words__WEBPACK_IMPORTED_MODULE_1__.answers[Math.floor(Math.random() * _words__WEBPACK_IMPORTED_MODULE_1__.answers.length)],
  currentRowIndex: 0,
  state: 'active',
  errors: false,
  message: '',
...
/* harmony export */ });
var answers = ["CAT", "DOG", "KID", "MUM", "DAD", "BIG", "HAT", "POP", "SIT", "HOP", "RAP", "CRY", "WIN", "LET", "WET", "RAG", "TAG", "POT", "MOP", "ARM", "PEN", "MIX", "ZOO", "SAM", "EGG", "EEL", "EAT", "DIP", "DOT", "BAT", "FAT", "MAT", "MAN", "FAN", "JAM", "HEN", "HUT", "HOT", "HIT", "PIT", "PAN", "CAR", "CAP", "YOU", "POO", "BUM", "LIP"];
